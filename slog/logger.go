...
// SetLogger sets logger that is used in grpc to a V2 logger.
...
func NewLoggerV2(debugW, infoW, warningW, errorW io.Writer) Logger {
	return NewLoggerV2WithVerbosity(debugW, infoW, warningW, errorW, 0)
}

// NewLoggerV2WithVerbosity creates a loggerV2 with the provided writers and
// verbosity level.
func NewLoggerV2WithVerbosity(debugW, infoW, warningW, errorW io.Writer, v int) Logger {
	var m []*log.Logger
...
func newLoggerV2() Logger {
	...
	return NewLoggerV2WithVerbosity(debugW, infoW, warningW, errorW, v)
}
